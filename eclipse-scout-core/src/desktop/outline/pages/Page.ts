...
import {
  ...
  EventSupport, Form, HtmlComponent, InitModelOf, inspector, Menu, MenuBar, ObjectIdProvider, ObjectOrChildModel, ObjectOrType, ObjectWithUuid, Outline, PageDetailMenuContributor, PageEventMap, PageModel, ParentTablePageMenuContributor,
...
export class Page extends TreeNode implements PageModel, ObjectWithUuid {
  ...
  /**
   * Compute the summary columns of the given {@link TableRow}. The summary columns are
   * <ol>
