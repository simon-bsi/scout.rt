...
import static org.eclipse.scout.rt.platform.util.CollectionUtility.emptyArrayList;
...
public abstract class AbstractJsPage extends AbstractPage<ITable> implements IJsPage {
  ...
  @Override
  public void loadChildPagesFromUI(List<IPageParamDo> pageParams, boolean replace) {
    try {
  ...
  /**
   * Override this method to create a child page using an {@link IPageParamDo} given by the Scout JS pendant of this page.
   */
  ...
  /**
   * Override this method to create a child page using an {@link IId} given by the Scout JS pendant of this page.
   */
  ...
  @Override
  public void changeNodeFromUI(ICell cell) {
    if (cell == null) {
      return;
    }
